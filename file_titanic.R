...
#new variable gathering all the rare ones
...
#there are some missing values and we have to input them
...
full[1044, ]
#he is a third class passenger who also embarked in 'S'
...
#variables are made into factors
